<?php
    $sql = "SELECT * FROM lista_servicios_header WHERE id_lista_servicio = '1'";
    $resultado = $conexion->query($sql);
    $banner = $resultado->fetch_assoc();
  ?>
<header class="container-fluid header-contabilidad"
  style="background-image: url(admin/img/servicios/header/<?php echo $banner['url_imagen']; ?>);">
  <div class="header-container-contabilidad h-100 d-flex flex-column justify-content-center text-center">
