<?php
    $sql = "SELECT * FROM lista_servicios_header WHERE id_lista_servicio = '2'";
    $resultado = $conexion->query($sql);
    $banner = $resultado->fetch_assoc();
  ?>
<header class="container-fluid header-nominas" 
  style="background-image: url(admin/img/servicios/header/<?php echo $banner['url_imagen']; ?>);">
  <div class="header-container-nominas h-100 d-flex flex-column justify-content-center text-center">
