...
<body>
  ...
  ?>
  <?php
    include_once 'templates/header-nominas.php';
  ?>
  ...
  <!-- <section class="container-fluid py-5 nosotros" id="Nosotros">
    <div class="container max-size pt-5" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="0"
      ...
      <div class="row">
        <div class="col-12">
          <h2 class="titulo-t2">Maquila de Nómina</h2>
          <p class="nosotros-p"><i>"El Capital Humano de tu empresa quedara en mano de ejecutivos altamente calificados. <br> Nos encargaremos de todos los procesos inherentes de tu nómina, desde la contratación hasta la terminación de la relación de trabajo."</i></p>
        </div>
      </div>
    </div>
  </section> -->
  ...
  <section class="container-fluid py-5 servicios" id="Servicios">
    <div class="row mx-0">
      ...
      <?php
        try {
        $sql_lss = "SELECT * FROM lista_servicios_servicios WHERE id_lista_servicio = '2' AND band_eliminar = 1";
        ...
        <div class="col-12 col-md-8 py-4 align-self-end h-100">
          <div class="container max-size orilla" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="0"
            ...
            try {
              ...
              $sql_lsss = "SELECT * FROM lista_servicios_servicios_sub WHERE id_lista_servicio = '2' AND id_lista_servicio_servicio = '$lss[id_lista_servicio_servicio]' AND band_eliminar = 1";
  ...
  <section class="container-fluid py-5 aviso" id="Aviso">
    <div class="container d-flex align-items-center flex-column max-size pt-5" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="0" data-aos-easing="ease-in-out">
      <!-- <h2 class="titulo-t1">Incrementa tu<font class="titulo-t2"> productividad</font> dejando en nuestras manos la<font class="titulo-t2"> operación</font> de tu<font class="titulo-t2"> nómina</font></h2> -->
      <h2 class="titulo-t1 pt-3"><font class="titulo-t2">¡Conoce todos los beneficios que nuestros servicios pueden traer a tu empresa!</font></h2>
    </div>    
