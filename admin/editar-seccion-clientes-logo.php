    ...
    <div class="row">
      <div class="col-md-8">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <?php
          $sql = "SELECT * FROM lista_clientes_logos WHERE id_lista_cliente_logo = $id";
          $resultado = $con->query($sql);
          $lista_clientes_logos = $resultado->fetch_assoc();
          // echo "<pre>";
          // var_dump($lista_clientes_logos);
          // echo "</pre>";

          ?>

            <!-- form start -->
            <form method="POST" action="funciones/modelo-seccion-clientes-logo.php" name="guardar-registro"
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="seo" id="seo"
                    placeholder="SEO" value="<?php echo $lista_clientes_logos['seo'];?>" maxlength="50" autocomplete="off">
                </div>

                <div class="form-group">
                  <label for="imagen_actual">Imagen Actual</label>
                  <br>
                  <img src="img/seccion_clientes_logos/<?php echo $lista_clientes_logos['url_logo'];?>" alt="" width="200">
                </div>
                ...
                <?php
                  if ($lista_clientes_logos['band_eliminar'] == 1) {
                    $data_switch = true;
                ...
                <div class="">
                  ...
                  <input type="hidden" name="id_registro" value="<?php echo $lista_clientes_logos['id_lista_cliente_logo'];?>">
