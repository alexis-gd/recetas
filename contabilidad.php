...
<body>
  ...
  ?>
  <?php
    include_once 'templates/header-contabilidad.php';
  ?>
  ...
  <!-- <section class="container-fluid py-5 nosotros" id="Nosotros">
    <div class="container max-size pt-5" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="0"
      ...
      <div class="row">
        <div class="col-12">
        <h2 class="titulo-t2">Vinculamos las áreas de su empresa</h2>
          <p class="nosotros-p"><i>"Nos convertimos en una firma que ofrece un servicio íntegro especializado en cada área, para satisfacer las necesidades primordiales de su empresa."</i></p>
        </div>
      </div>
    </div>
  </section> -->
  ...
  <section class="container-fluid py-5 servicios" id="Servicios">
    <div class="row mx-0">
      ...
      <?php
        try {
        $sql_lss = "SELECT * FROM lista_servicios_servicios WHERE id_lista_servicio = '1' AND band_eliminar = 1";
        ...
        <div class="col-12 col-md-8 py-4 align-self-end h-100">
          <div class="container max-size orilla" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="0"
            ...
            try {
              ...
              $sql_lsss = "SELECT * FROM lista_servicios_servicios_sub WHERE id_lista_servicio = '1' AND id_lista_servicio_servicio = '$lss[id_lista_servicio_servicio]' AND band_eliminar = 1";
  ...
  <section class="container-fluid py-5 aviso" id="Aviso">
    <div class="container d-flex align-items-center flex-column max-size pt-5" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="0" data-aos-easing="ease-in-out">
      <h2 class="titulo-t1">Te ayudamos a<font class="titulo-t2"> cumplir</font></h2>
      <h2 class="titulo-t1 pt-3">Tus <font class="titulo-t2">obligaciones fiscales</font></h2>
    </div>    
